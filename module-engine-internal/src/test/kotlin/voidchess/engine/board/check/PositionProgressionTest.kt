...
internal class PositionProgressionTest {
    ...
    fun getContainsData() :Array<Array<Any>> = arrayOf(
            arrayOf(PositionProgression(Position.byCode("e4"), 0, Direction.UP), setOf<String>(), setOf("d3", "d4", "d5", "e3", "e4", "e5", "f3", "f4", "f5")),
            arrayOf(PositionProgression(Position.byCode("e4"), 1, Direction.UP), setOf("e4"), setOf("d3", "d4", "d5", "e3", "e5", "f3", "f4", "f5")),
            arrayOf(PositionProgression(Position.byCode("e4"), 2, Direction.UP), setOf("e4", "e5"), setOf("d3", "d4", "d5", "e3", "e6", "f3", "f4", "f5")),
            arrayOf(PositionProgression(Position.byCode("c3"), 3, Direction.DOWN_LEFT), setOf("c3", "a1"), setOf("d4")),
            arrayOf(PositionProgression(Position.byCode("h1"), 3, Direction.LEFT), setOf("h1", "f1"), setOf("e1")),
            arrayOf(PositionProgression(Position.byCode("e7"), 4, Direction.RIGHT), setOf("e7", "h7"), setOf("d7", "e6", "e8"))
    )
}
