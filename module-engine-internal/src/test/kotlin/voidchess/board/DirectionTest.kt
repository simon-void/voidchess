...
class DirectionTest {
    ...
    fun testGetDiagonalSucceeds() {
        assertEquals(Direction.UP_LEFT, Direction.getDiagonal(Direction.UP, Direction.LEFT), "the diagonal of up and left")
        assertEquals(Direction.UP_RIGHT, Direction.getDiagonal(Direction.UP, Direction.RIGHT), "the diagonal of up and right")
        assertEquals(Direction.DOWN_RIGHT, Direction.getDiagonal(Direction.DOWN, Direction.RIGHT), "the diagonal of down and right")
        assertEquals(Direction.DOWN_LEFT, Direction.getDiagonal(Direction.DOWN, Direction.LEFT), "the diagonal of down and left")
    }
