package voidchess.engine.inner.evaluation

import voidchess.common.board.move.ExtendedMove
import voidchess.common.board.move.isPawnMove
import voidchess.engine.inner.evaluation.SearchTreePruner.Companion.MAX_SEARCH_DEPTH
...
internal class PrunerWithPawnMoves(override val allMoveRadius: Int = 2, private val pawnMoveRadius: Int = 3, private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) :
    SearchTreePruner {
...
internal class DefaultPruner(override val allMoveRadius: Int = 2, private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) :
    SearchTreePruner {
...
internal class SingleFullMovePruner(private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) :
    SearchTreePruner {
...
internal class SingleFullMovePrunerWithPawnMoves(private val pawnMoveRadius: Int = 2, private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) :
    SearchTreePruner {
