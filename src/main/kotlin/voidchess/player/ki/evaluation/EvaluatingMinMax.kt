...
class EvaluatingMinMax(var pruner: SearchTreePruner, var strategy: EvaluatingStatically) {
    ...
    private fun getMin(game: ChessGameInterface,
        ...
        val minEvaluationSelector = Selector(HighestEvaluationFirstComparator)
        ...
        for (move in minPossibleMovesBuffer) {
            ...
            when(game.move(move)) {
                ...
                MoveResult.CHECKMATE -> {
                    ...
                    minEvaluationSelector.propose(CheckmateSelf(depth + 1, secondaryMateEval))
                }
    ...
    private fun getMax(game: ChessGameInterface,
        ...
        val maxEvaluationSelector = Selector(LowestEvaluationFirstComparator)
