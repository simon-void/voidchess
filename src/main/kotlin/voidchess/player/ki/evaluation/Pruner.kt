...
import voidchess.player.ki.evaluation.SearchTreePruner.Companion.MAX_SEARCH_DEPTH
...
enum class ContinueEvalBy {
    StaticEval, AllMoves, IrreversibleMoves, TakingMoves
}

class PrunerWithIrreversibleMoves(private val allMoveRadius: Int = 1, private val irreversibleMoveRadius: Int = 2, private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) : SearchTreePruner {
...
class AllMovesOrNonePruner(private val allMoveRadius: Int = 1, private val takingMoveRadius: Int = 4, private val lookForCheckMateRadius: Int = 3) : SearchTreePruner {
