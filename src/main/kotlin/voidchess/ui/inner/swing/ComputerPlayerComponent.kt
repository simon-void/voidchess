...
internal class ComputerPlayerComponent : JComponent(), ComputerPlayerUI {
    ...
    private fun drawFace(g: Graphics) {
        ...
        g.drawLine(
            HAT_START_X + HAT_WIDTH / 2 - KIN_WIDTH / 2,    // chin
                HEAD_END_Y,
                HAT_START_X + HAT_WIDTH / 2 + KIN_WIDTH / 2,
                HEAD_END_Y
        )
        g.drawLine(
            HAT_START_X + HAT_WIDTH / 2 - KIN_WIDTH / 2,    // left face
                HEAD_END_Y,
                HAT_START_X,
                HAT_START_Y + HAT_HEIGHT
        )
        g.drawLine(
            HAT_START_X + HAT_WIDTH / 2 + KIN_WIDTH / 2,    // right face
                HEAD_END_Y,
                HEAD_END_X,
                HAT_START_Y + HAT_HEIGHT
        )
        ...
        g.fillOval(
            FACE_MIDDLE - GLASS_DISTANCE / 2 - GLASS_DIAMETER, // left eye-glass
                EYE_HEIGHT - GLASS_DIAMETER / 2,
                GLASS_DIAMETER,
                GLASS_DIAMETER
        )
        g.fillOval(
            FACE_MIDDLE + GLASS_DISTANCE / 2,                  // right eye-glass
                EYE_HEIGHT - GLASS_DIAMETER / 2,
                GLASS_DIAMETER,
                GLASS_DIAMETER
        )
        ...
        g.color = Color.black
        g.drawOval(
            FACE_MIDDLE - GLASS_DISTANCE / 2 - GLASS_DIAMETER, // left eye-glass's frame
                EYE_HEIGHT - GLASS_DIAMETER / 2,
                GLASS_DIAMETER,
                GLASS_DIAMETER
        )
        g.drawOval(
            FACE_MIDDLE + GLASS_DISTANCE / 2,                  // right eye-glass's frame
                EYE_HEIGHT - GLASS_DIAMETER / 2,
                GLASS_DIAMETER,
                GLASS_DIAMETER
        )
        ...
        g.drawLine(
            FACE_MIDDLE - GLASS_DISTANCE / 2,                 // glasses bridge
                EYE_HEIGHT,
    ...
    private fun drawMouth(g: Graphics) {
        ...
        g.drawLine(
            FACE_MIDDLE - MOUTH_WIDTH / 2 + 10, // mouth
                MOUTH_HEIGHT,
                FACE_MIDDLE + MOUTH_WIDTH / 2 - 10,
                MOUTH_HEIGHT
        )
        g.drawLine(
            FACE_MIDDLE - MOUTH_WIDTH / 2,
    ...
    private fun drawHand(g: Graphics) {
        ...
        if(thumbAction== Thumb.UP) {
            ...
            g.drawRect(
                HAND_START_X + HAND_WITH - THUMB_WIDTH, // thumb
    ...
    companion object {
        ...
        private val MOUTH_RECTANGLE = Rectangle(
            FACE_MIDDLE - MOUTH_WIDTH / 2 - 1,
                MOUTH_HEIGHT - 8,
                MOUTH_WIDTH + 2,
                16)
        private val HAND_RECTANGLE = Rectangle(
            HAND_START_X - 1,
