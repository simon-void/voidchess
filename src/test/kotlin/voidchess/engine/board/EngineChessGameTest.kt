...
internal class EngineChessGameTest {
    ...
    fun testWithMove() {
        ...
        game = initEngineChessGame(707,"e1-f3","b7-b6","f1-e3","g7-g6","d1-e1","a8-f3") as EngineChessGameImpl
        des = game.toString()
    ...
    fun testIsMatt() {
        ...
        val game = initEngineChessGame(des)
    ...
    fun testIsDrawBecauseOfThreeTimesSamePosition(des: String, listOfMoves: List<String>) {
        ...
        val game = initEngineChessGame(des, *listOfMoves.subList(0, nextToLastIndex).toTypedArray())
    ...
    fun testGetPossibleMoves(startConfig: StartConfig, moveCodes: Array<String>, expectedPossibleMovesCount: Int) {
        val game = initEngineChessGame(startConfig, *moveCodes)
    ...
    fun testShortTermHistory(chess960: Int, moves: Array<String>, expectedShortTermHistory: String) {
        val game = initEngineChessGame(chess960, *moves)
    ...
    fun testGetCompleteHistory(initialPos: Int, expectedCompleteHistory: String) {
        ...
        val game = initEngineChessGame(initialPos, *moveArray)
