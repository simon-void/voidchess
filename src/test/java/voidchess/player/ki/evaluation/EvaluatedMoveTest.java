...
public class EvaluatedMoveTest {
    ...
    public void testCompareTo() {
        EvaluatedMove e1_1 = new EvaluatedMove(Move.byCode("b2-b4"), new EvaluatedAsValue(.1f));
        EvaluatedMove e1_2 = new EvaluatedMove(Move.byCode("c2-c4"), new EvaluatedAsValue(.1f));
        EvaluatedMove e2 = new EvaluatedMove(Move.byCode("b2-b4"), new EvaluatedAsValue(-.1f));
        EvaluatedMove e3 = new EvaluatedMove(Move.byCode("f2-f4"), new EvaluatedAsValue(1.2f));
    ...
    public void testOrderingInSortedSet() {
        ...
        set.add(new EvaluatedMove(Move.byCode("a2-a3"), new EvaluatedAsValue(-1.2f)));//7.
        set.add(new EvaluatedMove(Move.byCode("b2-b3"), new EvaluatedAsValue(-0.5f)));//6.
        set.add(new EvaluatedMove(Move.byCode("c2-c3"), new EvaluatedAsValue(4.6f)));//3.
        set.add(new EvaluatedMove(Move.byCode("d2-d3"), new EvaluatedAsValue(2.1f)));//4.
        set.add(new EvaluatedMove(Move.byCode("e2-e3"), EvaluatedAsDraw.INSTANCE));//5.
        set.add(new EvaluatedMove(Move.byCode("f2-f3"), new EvaluatedAsMatt(1, false)));//9.
        set.add(new EvaluatedMove(Move.byCode("g2-g3"), new EvaluatedAsMatt(2, false)));//8.
        set.add(new EvaluatedMove(Move.byCode("h2-h3"), new EvaluatedAsMatt(1, true)));//1.
        set.add(new EvaluatedMove(Move.byCode("h2-h4"), new EvaluatedAsMatt(2, true)));//2.
