...
public class SimplePruner implements SearchTreePruner
{
	...
	public SimplePruner( int no_hit_radius,int figure_hit_radius,int chess_radius )
	{
		...
		if( figure_hit_radius < no_hit_radius ) throw new IllegalArgumentException( "figure_hit_radius cann't be smaller than no_hit_radius" );
		if( chess_radius      < no_hit_radius ) throw new IllegalArgumentException( "chess_radius cann't be smaller than no_hit_radius"  ); 
	...
	/* (non-Javadoc)
	 * @see player.ki.SearchTreePruner#stopMinDynamicEvaluation(int, boolean, boolean, boolean, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see player.ki.SearchTreePruner#stopMaxDynamicEvaluation(int, boolean, boolean, boolean, boolean)
	 */
