...
internal class MiddleGameEvalTest {
    ...
    fun symmetricPositionProvider(): Array<Array<Any>> {
        return arrayOf(
            ...
            arrayOf<Any>(initChessGame(518)),
            arrayOf<Any>(initChessGame(333)),
            arrayOf<Any>(initChessGame(518, "g2-g3", "g7-g6", "g1-f3", "g8-f6", "f1-g2", "f8-g7", "e1-h1", "e8-h8", "c2-c3", "c7-c6")))
    }
    ...
    fun asymmetricPositionProvider(): Array<Array<Any>> {
        return arrayOf(
                ...
                arrayOf<Any>(initChessGame(518, "g2-g3", "g7-g6", "g1-f3", "g8-f6", "f1-g2", "f8-g7", "e1-h1"))
                )
    }
