...
public class TarotCardDeck
{
  ...
  public TarotCardDeck(int cardPixelWidth)
  {
    ...
    DeckBuilder majorArcanaBuilder = new DeckBuilder("majorarcana", deck);
    ...
    addMinorArcana("Wands", deck);
    addMinorArcana("Pentacles", deck);
    addMinorArcana("Cups", deck);
    addMinorArcana("Swords", deck);
  }
  
  private void addMinorArcana( String arcanaName, List<TarotCardInfo> deckToAddCardsToo)
  {
    ...
    DeckBuilder deckBuilder = new DeckBuilder("minorarcana/tarot-"+arcanaName.toLowerCase()+".htm", deck);
  ...
  class DeckBuilder
  {
    ...
    public DeckBuilder(final String explainFolder, final List<TarotCardInfo> deckToAddCardsToo)
    {
      this.deckToAddCardsToo = deckToAddCardsToo;
      
      final String webpage = "http://www.tarot-card.info/";
      
      explainFolderPath = webpage + explainFolder;
      imgFolderPath     = webpage + "tarotcards/";
